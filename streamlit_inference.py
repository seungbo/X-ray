# streamlit run streamlit_inference.py "/Users/seungbo/Downloads/expo/X-ray-main/model(Segmentation)/best"
...
class Inference:
    ...
    def web_ui(self):
        ...
        font-family: 'Archivo', sans-serif; margin-bottom:20px;">공항 X-ray 위험물품 탐지</h1></div>"""

        # Subtitle of streamlit application
        sub_title_cfg = """<div><h4 style="color:#042AFF; text-align:center; font-family: 'Archivo', sans-serif; 
        margin-top:-15px; margin-bottom:50px;">일반물품, 위해물품, 정보저장매체를 탐지하여 결과를 보여줍니다.</h4></div>"""
    ...
    def inference(self):
        ...
        if self.st.sidebar.button("Start"):
            ...
            col1.markdown("<h3 style='text-align: center;'>원본</h3>", unsafe_allow_html=True)
            col2.markdown("<h3 style='text-align: center;'>결과</h3>", unsafe_allow_html=True)
